...
/// <summary><br />
/// Base server controller.  Primarily used when running the server as-is<br />
/// (e.g. as an executable) versus wrapping it to cater to a given client's<br />
/// needs (e.g. as a DLL).<br />
/// </summary><br />
class ServerController : ApplicationController<br />
{<br />
}
